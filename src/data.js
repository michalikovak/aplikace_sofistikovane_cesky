const data = [
  ...
  {
    lesson: 1,
    contextParagraph: "V sedmdesátých letech dvacátého století mnoho politiků, zejména na jihu USA, stále zastávalo demagogický názor o nadřazenosti bílé rasy. Nezakládal se však na žádných exaktních podkladech. M.L. King se rozhodl proti této xenofobii bojovat. Jako první začal polemizovat o nesmyslnosti segregace černošského obyvatelstva. Byl to velice vzdělaný a empatický člověk, který se dokázal vcítit do potřeb a pocitů černošské populace. Svou agilností dokázal přesvědčit i řadu politiků zastávajících vysoké posty. Svými, vždy velice sofistikovanými projevy, dokázal oslovit čím dál tím vetší davy. Oponenty mu bylo vyčítáno, že sice bojuje za práva chudých, ale sám často vede život, který se nedá zrovna nazvat asketickým. Vítězství pravdy a rozumu se však nedočkal. Jeho život ukončil cynický a všeho schopný, bývalý vězeň J.E. Roy 4.4.1968.",
    words: [
      {
        word: "asketický",
    ...
    test: [
      ...
      {
        questionStart: "V závěru svého výzkumu došel k názotu, že psycholgii barev nelze považovat za",
        questionEnd: "vědu.",
        options1: ["asketický", "sofistikovany", "cynik", "demagogický", "polemika", "exaktní", "segregace", "empatie", "agilní", "xenofobie"],
      },
      {
    ...
    test: [
      {
        ...
        options2: ["invektiva", "afektovaný", "flegmatik", "faux pas", "pofidérní", "cholerik", "pragmatický", "eminentní", "despota", "latentní"],
      },
      {
    ...
    test: [
      {
        ...
        options3: ["ad hoc", "vágní", "ostentativní", "konvence", "apriori", "dilatace", "obligatorní", "irelevantní", "ratifikace", "marginální"],
      },
      {
    ...
    test: [
      {
        ...
        questionEnd: " dáma.",
        options4: ["žoviální", "obsedantní", "patetický", "inzultace", "ješitný", "analfabet", "egoista", "fabulace", "sarkastický", "precedent"],
      },
      {
    ...
    test: [
      {
        ...
        options5: ["zádumčivost", "pejorativní", "obskurní", "blazeovaný", "filantropie", "misogyn", "ambivalentní", "eufemizmus", "emancipace", "melancholik"],
      },
      {
