export default [

  {
    ...
    test: [
      {
        questionStart: "Byl nesmírně skromný, až",
        questionEnd: ", v jídle, v oblékání a ve všech materiálních věcech , které pro něj nic neznamenaly.",
        result: "asketický",
      },
      {
      ...
      },
      {
        ...
        questionEnd: "se může zachovat v této situaci bezohledně.",
        result: "cynik",
      },
      {
        questionStart: "Seriál o sovětských vůdcích zlehčuje zločiny komunismu, televize vysílá",
        questionEnd: "bulvár.",
        result: "demagogický",
      },
      {
        questionStart: "",
        questionEnd: "nabívala na vášnivosti a obě strany se coby důkaz svých tvrzení oháněly vlastní analýzou rizik.",
        result: "polemika",
      },
      {
        questionStart: "V závěru svého výzkumu došel k názoru, že psycholgii barev nelze považovat za",
        questionEnd: "vědu.",
        result: "exaktní",
      },
      {
        questionStart: "Zarazil ji nejen význam církve v této zemi, ale také nápadná",
        questionEnd: "mezi pohlavími.",
        result: "segregace",
      },
      {
      ...
      {
        questionStart: "Náš pes je stále stejně",
        questionEnd: ", jako když byl ještě štěně.",
        result: "agilní",
      },
      {
        questionStart: "Jen jak si všimnou Davidovi jarmulky je cítit, jak se nad davem rozplývá mrak",
        questionEnd: "a zanechává po sobě opar rasismu.",
        result: "xenofobie",
      },
    ],
  },
  {
    ...
    words: [
      ...
      },
      {
        ...
        context: "Šéf, kterého celý tým mylně považoval za flegmatika, začal zuřivě bušit pěstmi do stolu a hlasitě nadávat.",
      },
      {
        word: "faux pas",
      ...
      },
      {
        ...
        context: "Vzdát čest přišlo kolem padesátky eminentních vědců.",
      },
      {
        word: "despota",
    ...
    test: [
      {
        questionStart: "V našem vztahu je urážka,",
        questionEnd: ", stesk a nenávist na denním pořádku.",
        result: "invektiva"
      },
      {
        questionStart: "Hlavní rolí filmu byl ",
        questionEnd: ", teatrální homosexuál James.",
        result: "afektovaný",
      },
      {
        questionStart: "Jedině ",
        questionEnd: " může zvládnout zkouškové období bez nervového zhroucení.",
        result: "flegmatik",
      },
      {
        questionStart: "Premiér si nepotřásl rukou s diplomatem a dopustil se tak ",
        questionEnd: ".",
        result: "faux pas",
      },
      {
        questionStart: "",
        questionEnd: " obchodník nabízel důchodcům nerezové hrnce za tisíce korun.",
        result: "pofidérní",
      },
      {
        questionStart: "Ač působí klidně, je to ",
        questionEnd: ", který dokáže vybuchnout z ničeho nic.",
        result: "cholerik",
      },
      {
        questionStart: "Sdílíme ",
        questionEnd: " přístup k výchově dětí.",
        result: "pragmatický",
      },
      {
        questionStart: "Trenér Bohemians 1905 má ",
        questionEnd: " zájem o brankáře z Plzně.",
        result: "eminentní",
      },
      {
        questionStart: "Dobře věděl, že jeho otec byl krutý a bezohledný ",
        questionEnd: ".",
        result: "despota",
      },
      {
        questionStart: "Po užití drogy se zesílily a podpořily jeho normálně potlačené ",
        questionEnd: " bisexuální sklony.",
        result: "latentní",
      },
    ],
  },
  {
    ...
    test: [
      {
        questionStart: "Firma prudký růst organizačně nezvládne, jelikož se podnik rozvíjel ",
        questionEnd: ", bez jasného záměru či strategie.",
        result: "ad hoc",
      },
      {
        questionStart: "Poslala nám příliš ",
        questionEnd: " informace na to, abychom našli přesnou adresu.",
        result: "vágní",
      },
      {
        questionStart: "Společnost pohlíží s pohrdáním na ",
        questionEnd: " kupení majetku a utrácení.",
        result: "ostentativní",
      },
      {
        questionStart: "",
        questionEnd: " OSN proti mezinárodnímu organizovaném zločinu.",
        result: "konvence",
      },
      {
        questionStart: "Na hudební projev mladé generace se ",
        questionEnd: " pohlíželo jako na něco podezřelého až vulgárního.",
        result: "apriori",
      },
      {
        questionStart: "Po užití kokainu nastane zjevná ",
        questionEnd: " zorniček.",
        result: "dilatace",
      },
      {
        questionStart: "Jedná se o povinnost ",
        questionEnd: " s výjimkami v zákoně stanovenými.",
        result: "obligatorní",
      },
      {
        questionStart: "Myslím si, že jste zamlčel, co se vám zdá být ",
        questionEnd: ", a neuvědomujete si, že pro nás je důležitý i zdánlivě nepodstatný fakt.",
        result: "irelevantní",
      },
      {
        questionStart: "Nejviditelnějším prezidentem je současný český prezident Václav Klaus, který držel v šachu během ",
        questionEnd: " Lisabonské smlouvy celou Evropskou unii.",
        result: "ratifikace",
      },
      {
        questionStart: "Muži vidí v tyrkysové a zelené naprosto ",
        questionEnd: " rozdíl, ne-li žádný.",
        result: "marginální",
      },
    ],
  },
  {
    ...
    test: [
      {
        questionStart: "Naše sousedka je starší, usměvavá, ",
        questionEnd: " dáma.",
        result: "žoviální",
      },
      {
        questionStart: "Silně rozvinutá ",
        questionEnd: " porucha jí nedovolovala posedět na jednom místě déle než pár chvil.",
        result: "obsedantní",
      },
      {
        questionStart: "",
        questionEnd: " projev ulhaného politika působil směšně.",
        result: "patetický",
      },
      {
        questionStart: "Já jí za její hrubé chování označím za původkyni fyzické ",
        questionEnd: " a tohle oznámení bude podepřeno řadou výpovědí.",
        result: "inzultace",
      },
      {
        questionStart: "K natáčení nedošlo proto, že ",
        questionEnd: " McQueen nesnesl, že by jeho jméno mělo být uváděno až druhé za Rossovou, a z projektu vycouval.",
        result: "ješitný",
      },
      {
        questionStart: "Před sebou měl dojemnou ukázku toho, jak se poloviční ",
        questionEnd: " pokouší napsat svůj první dopis.",
        result: "analfabet",
      },
      {
        questionStart: "Je to sobecký ",
        questionEnd: ". Myslí jenom na sebe a mně zlomil srdce.",
        result: "egoista",
      },
      {
        questionStart: "Může to být jen ",
        questionEnd: " , autorka si mohla všechno prostě vymyslet.",
        result: "fabulace",
      },
      {
        questionStart: "Zaslechl jsem ",
        questionEnd: " tón? Nebo snad ironii?",
        result: "sarkastický",
      },
      {
        questionStart: "Kopromitoval byste bezpečnost státu a tím vytvořil nebezpečný ",
        questionEnd: ".",
        result: "precedent",
      },
    ],
  },
  {
    ...
    test: [
      {
        questionStart: "Jako dítě trpěl ztrátou obou rodičů, což v něm navodilo jistou ",
        questionEnd: ", byl plachý a zamlklý.",
        result: "zádumčivost",
      },
      {
        questionStart: "Typy temperamentu se používají i v laické řeči, a často mají ",
        questionEnd: " nádech.",
        result: "pejorativní",
      },
      {
        questionStart: "Je stoupenkyní jakési ",
        questionEnd: " sekty, která věří, že delfíni jsou požehnanou rasou.",
        result: "obskurní",
      },
      {
        questionStart: "Nenazývala bych to manželskou krizí, můj muž je jen po těch dvaceti společných letech ",
        questionEnd: ".",
        result: "blazeovaný",
      },
      {
        questionStart: "Milionář v rámci své ",
        questionEnd: " věnoval část majetku charitě.",
        result: "filantropie",
      },
      ...
      },
      {
        ...
        questionEnd: ". Mlčí se s ním velmi inspirativně.",
        result: "melancholik",
      },
    ],
  },
